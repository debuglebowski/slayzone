...
const api: ElectronAPI = {
  ...
  app: {
    ...
    isAgentManagerEnabled: () => ipcRenderer.invoke('app:is-agent-manager-enabled'),
    isAgentManagerEnabledSync: ipcRenderer.sendSync('app:is-agent-manager-enabled-sync') as boolean,
