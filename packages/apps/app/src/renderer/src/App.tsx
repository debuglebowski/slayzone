    ...
    const s = trpcClient.app.menu.onUpdateStatus.subscribe(undefined, {
      onData: (raw) => {
        ...
        switch (status.type) {
          ...
          case 'downloading': setUpdateDownloadPercent(status.percent ?? null); toast.dismiss('update-check'); break
          case 'downloaded': toast.dismiss('update-check'); setUpdateDownloadPercent(null); setUpdateVersion(status.version ?? null); setUpdateToastDismissed(false); break
