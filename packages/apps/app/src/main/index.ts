...
div{text-align:center}h1{font-size:14px;font-weight:500;color:#aaa}p{font-size:12px;margin:8px 0 0;word-break:break-all;max-width:400px}</style>
  ...
  ipcMain.handle('app:is-agent-manager-enabled', () => isLabEnabled('labs_agent_manager'))
  ipcMain.on('app:is-agent-manager-enabled-sync', (event) => { event.returnValue = isLabEnabled('labs_agent_manager') })
