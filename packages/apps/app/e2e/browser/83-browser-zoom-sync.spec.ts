...
// Reclaimed 2026-06-20: all pass under workers=1; the 2026-05-16 bounds
// mismatch was parallel-run WCV compositor lag, not a real defect.
  ...
  async function setBrowserDefaultZoom(page: Page, percent: string): Promise<void> {
    await page.evaluate(async (value) => {
      await window
        ...
        .settings.set.mutate({ key: 'browser_default_zoom', value })
