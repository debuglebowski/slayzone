...
import { useHomePanel, HOME_PANEL_SIZE_KEY } from './useHomePanel'
import {
  FilterBar,
  KanbanBoard,
  KanbanListView,
...
// Minimal structural shapes for app-chrome props — the Electron app passes
// richer objects; only these fields are read here. Keeps @slayzone/home
// decoupled from app-local agent-panel state + settings-tab constants.
type GlobalAgentPanelState = { isOpen: boolean }
type AgentStatusState = { isLocked: boolean }
