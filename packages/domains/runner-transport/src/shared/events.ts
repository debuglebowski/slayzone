/**
 * Minimal typed event emitter used by the runner gateway and dialer. Kept
 * dependency-free on purpose — @slayzone/runner-transport only depends on ws + zod.
 *
 * @module runner/shared/events
 */
