...
export function initAiConfigOps(db: SlayzoneDb): { ai: AiConfigOps; market: MarketplaceOps } {
...
export function getMarketplaceOps(): MarketplaceOps {
  if (!marketplaceOps)
    throw new Error('marketplaceOps not initialized — call initAiConfigOps(db) first')
