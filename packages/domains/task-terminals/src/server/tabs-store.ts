...
export function listTabsForTask(db: Database, taskId: string): TerminalTab[] {
  const rows = db
...
export function moveTabToGroup(db: Database, tabId: string, targetGroupId: string | null): TerminalTab | null {
...
export function updateTab(db: Database, input: UpdateTerminalTabInput): TerminalTab | null {
